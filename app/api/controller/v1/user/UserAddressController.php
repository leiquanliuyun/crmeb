...
class UserAddressController
{
    ...
    public function address_edit(Request $request)
    {
        ...
        if (!isset($addressInfo['address']['province']) || !$addressInfo['address']['province']) return app('json')->fail('收货地址格式错误!');
        if (!isset($addressInfo['address']['city']) || !$addressInfo['address']['city']) return app('json')->fail('收货地址格式错误!');
        if (!isset($addressInfo['address']['district']) || !$addressInfo['address']['district']) return app('json')->fail('收货地址格式错误!');
