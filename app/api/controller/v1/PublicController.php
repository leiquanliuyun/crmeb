    ...
    public function menu_user(Request $request)
    {
        ...
        foreach ($menusInfo as $key => &$value) {
            ...
            if ($value['url'] == '/pages/users/user_vip/index' && !$vipOpen)
                unset($menusInfo[$key]);
            if ($value['url'] == '/pages/users/user_spread_user/index' && (!$brokerageFuncStatus || !($isUserPromoter)))
                unset($menusInfo[$key]);
            if ($value['url'] == '/pages/users/user_money/index' && !$balanceFuncStatus)
                unset($menusInfo[$key]);
            if ($value['url'] == '/pages/admin/order/index' && !$userService)
                unset($menusInfo[$key]);
            if (!$userVerifyStatus && !$deliveryUser && $value['url'] === '/pages/admin/order_cancellation/index')
                unset($menusInfo[$key]);
            ...
            if ($value['url'] == '/pages/users/user_invoice_list/index' && !$invoiceStatus)
                unset($menusInfo[$key]);
            if ($value['url'] == '/kefu/mobile_list' && !$userService) {
                unset($menusInfo[$key]);
            } elseif ($value['url'] == '/kefu/mobile_list' && $userService) {
            ...
            if ($uid == 0) {
                if ($value['url'] == '/pages/users/user_spread_user/index' || $value['url'] == '/pages/admin/order/index' || $value['url'] === '/pages/admin/order_cancellation/index' || $value['url'] == '/kefu/mobile_list') unset($menusInfo[$key]);
            }
        }
